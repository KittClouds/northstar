...
use boundaries::verify_boundaries;
...
pub struct GoldenGrammarReport {
    ...
    pub ledger_hash_assertions: usize,
    pub terminal_hash_assertions: usize,
...
pub fn verify_golden_grammar() -> Result<GoldenGrammarReport, String> {
    ...
    let (ledger_hash_assertions, terminal_hash_assertions) =
        crate::golden_exact::verify_exact_golden()?;
