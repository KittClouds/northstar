...
//| Legacy Breakout-compatible geometry + causal state + grammar     |
//+------------------------------------------------------------------+
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME,
                      "Opening Range Legacy State Grammar [" +
...
{
   // Buffer-rendered legacy lines require no chart-object cleanup.
}
//+------------------------------------------------------------------+
