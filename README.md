...
frozen MQL5 golden fixtures, including byte-exact ledger serialization and the
terminal accumulator. It is deliberately not wired into the live office runtime
yet; see `research/auction-parity/PHASE12_CHECKPOINT.md`.
